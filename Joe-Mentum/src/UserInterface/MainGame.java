...
public class MainGame extends JFrame implements EventListener, KeyListener {
	...
	private static final String floor = "res/images/floor.png";
	private static final String sTile = "res/images/sTile.png";
	private static final String lTile = "res/images/lTile.png";
	private static final String fTile = "res/images/floorTile.png";
	...
	public MainGame() {
		...
		try {
			...
			hpHeart = ImageIO.read(new File("res/gui/heart.png"));
			exp = ImageIO.read(new File("res/gui/exp.png"));
			lvlStar = ImageIO.read(new File("res/gui/Level.png"));
			itemFrame = ImageIO.read(new File("res/gui/item.png"));
	...
	public void setup() {
		...
		audio.pause();
		audio = new MP3Player();
		audio.addToPlayList(new File("res/music/maintheme.mp3"));
		audio.skipForward();
		audio.play();
